...
def data_prep(
    ...
    try:
        ...
        for data in intermediate_data:
            ...
            print(
                f"File: {file_name}, Label: {label}, Type: {type_}, Timepoints: {data_points}, "
            ...
            for i in range(num_chunks):
                ...
                chunk = raw.copy().crop(
                    tmin=start / raw.info["sfreq"], tmax=end / raw.info["sfreq"]
                )
                ...
                entry = {
                    ...
                    "total_time (in seconds)": chunk.get_data().shape[1]
                    / chunk.info["sfreq"],
                }
...
def create_model_dir(data, main_dir, target_dir):
    for index, row in data.iterrows():
        ...
        file_path = (
            f"{main_dir}/{participant_id}/eeg/{participant_id}_task-eyesclosed_eeg.set"
        )
...
d1 = "../eeg_data/participants.tsv"  # Go up one level to access eeg-data
d2 = "../eeg_data/derivatives"
d3 = "intermediate_data"
d4 = "model_data"
