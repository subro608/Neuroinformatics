...
print(eegnet_model)
print(
    f"Model params: num_channels={num_chans}, timepoints={timepoints}, num_classes={num_classes}, F1={F1}, "
...
scheduler = optim.lr_scheduler.LinearLR(
    optimizer, start_factor=0.9, end_factor=0.001, total_iters=epochs * 5
)
...
for fold, (train_index, valid_index) in enumerate(
    ...
    for epoch in range(epochs):
        ...
        print(
            f"Fold {fold + 1}/5, Epoch {epoch + 1}/{epochs}, Train Loss: {train_loss:.6f}, "
