...
def test_model(data_type="test_cross", include_wavelet=True):
    ...
    try:
        model = MVTEEG(num_channels=num_chans, num_classes=num_classes, dim=dim)
...
if __name__ == "__main__":
    ...
    within_acc_nowave, within_f1_nowave = test_model(
        "test_within", include_wavelet=False
    )

    print("\n=== Comparing Results ===")
    print("With Wavelet Features:")
    print(
        f"  Cross-subject - Accuracy: {100 * cross_acc_wave:.2f}%, F1: {100 * cross_f1_wave:.2f}%"
    )
    print(
        f"  Within-subject - Accuracy: {100 * within_acc_wave:.2f}%, F1: {100 * within_f1_wave:.2f}%"
    )

    print("\nWithout Wavelet Features:")
    print(
        f"  Cross-subject - Accuracy: {100 * cross_acc_nowave:.2f}%, F1: {100 * cross_f1_nowave:.2f}%"
    )
    print(
        f"  Within-subject - Accuracy: {100 * within_acc_nowave:.2f}%, F1: {100 * within_f1_nowave:.2f}%"
    )
    ...
    print(
        f"  Cross-subject - Accuracy: {100 * cross_acc_imp:.2f}%, F1: {100 * cross_f1_imp:.2f}%"
    )
    print(
        f"  Within-subject - Accuracy: {100 * within_acc_imp:.2f}%, F1: {100 * within_f1_imp:.2f}%"
    )
